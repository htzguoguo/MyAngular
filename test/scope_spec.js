...
describe( 'Scope', function () {
    ...
    describe( 'digest', function () {
        ...
        it( 'calls the listener function what the watched value changed', function (  ) {
            scope.someValue = 'a';
            scope.counter = 0;
            scope.$watch(
        ...
        it( 'triggers chained watchers in the same digest', function ( ) {
            ...
            scope.$watch( function () { return scope.nameUpper; },
        ...
        it( 'gives up on the watches after 10 iterations', function (  ) {
            scope.counterA = 0;
            scope.counterB = 0;
            scope.$watch( function ( scope ) { return scope.counterA; },
